    ...
    var imJs = {
        ...
        testimonialActivation: function () {
            ...
            $('.testimonial-item-one').slick({
                ...
                adaptiveHeight: true,
                cssEase: 'linear',
                prevArrow: '<button class="slide-arrow prev-arrow"><i class="fa-solid fa-arrow-left"></button>',
                nextArrow: '<button class="slide-arrow next-arrow"><i class="fa-solid fa-arrow-right"></i></button>',
                responsive: [
                {
                    breakpoint: 1200,
        ...
        vedioActivation: function (e) {
            $('#play-video, .play-video').on('click', function (e) {
                ...
                $("#video-overlay, .video-overlay").append('<iframe width="80%" height="80%" src="" frameborder="0" allowfullscreen></iframe>');
            });
